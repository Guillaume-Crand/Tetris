...
class page:
	...
	### Les fonctions associés aux boutons
	def fen_1(self):
		self.boutons.append(Bouton("Jouer"	,(200,200,270,50),self.fen_2)) #330, 225
		self.boutons.append(Bouton("Options",(200,300,270,50),self.fen_option)) #330, 325
		self.boutons.append(Bouton("Quitter",(200,400,270,50),self.fen_2)) #330, 425
	def fen_2(self):

	def fen_options(self):
