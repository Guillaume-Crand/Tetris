...
class Menu:
    ...
    def __init__(self):
        ...
        self.couleurs={"rouge": (255,0,0), "vert":(0,255,0), "bleu":(0,0,255), 
                       "gris": (86,86,86), "blanc":(255,255,255)}
...
class SecondFrame:
    ...
    def multilocal(self):
        tests.partie(2)
        """serveur=reseau
        lancementServeur=serveur.Server().start"""
