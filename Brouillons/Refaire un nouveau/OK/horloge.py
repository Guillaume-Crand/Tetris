...
pygame.font.init()
class horloge:
	def __init__(self, screen, position = Rect((120,10),(190,90)), couleur = (255,0,0), taille = 72):
	...
	def actualisation(self):
		""" Met à jour le temps """
		self.s += 1
		self.texte = self.police.render("   "+str(self.m)+":"+ str(self.s)+"   ",False,self.couleur,(0,0,0))
